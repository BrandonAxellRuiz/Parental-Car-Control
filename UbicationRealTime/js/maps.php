<?php
    ...
    require_once "../../bd/Connecction.php";
    $conexion = new Connecction;
    $conexionm = $conexion -> dbConectionm();
    $result = $conexion -> prepare("SELECT * FROM ubication_real WHERE status = :status");
...
?>
    ...
    <body id="map-canvas">
       ...
       <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCxdeJGWxHFFwqX5ECjDEL5XOuUjnuYq00&callback=initialize">
    </script>
