...
<html lang="es">
    <head>
        ...
        <title>Lectura | Seguimiento de geolocalizacion | Soluciones en TI</title>
...
<div class="col-md-6 col-md-offset-3">
    <div class="booking-form-wrapper">
        ...
        <button onclick="detener()"  id="fin" class="waves-effect waves-light btn red mt-30">
               Finalizar localizacion
        </button> 
        <button onclick="carga()" id="iniciar"  class="waves-effect waves-light btn green mt-30">
                Iniciar seguimiento de geolocalizacion
        </button>   
 ...
 <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.3.1/jquery.min.js"></script>
    ...
    <script async defer
        src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCxdeJGWxHFFwqX5ECjDEL5XOuUjnuYq00&callback=carga">
        </script>
